...
public class TransactionCommandsTest extends BlankDatafileTestCase
{
    ...
    /*
     * Verify that the Transaction laid down by the above
     * PostTransactionCommand actually persisted fully.
     */
    ...
    public final void testDatestampSettingByPostTransactionCommand() {
        ...
        /*
         * Now use a PostTransactionCommand to attempt to store the
         * Transaction.
         */
    ...
    public final void testUpdateTransaction() throws Exception {
        ...
        /*
         * Hello. If you're running unit tests, and they fail here, then
         * you've probably run into an activation problem related to the fact
         * that "another" didn't actually have it's stale data cleared after
         * all. Damn and other comments.
         */
        ...
        /*
         * And now the same series of checks: one Transaction, two Entries,
         * both Debit now.
         */
        another = Engine.gainClient();
        result = another.queryByExample(Transaction.class);
