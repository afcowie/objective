...
public class ComparatorsInTreeSetTest extends BlankDatafileTestCase
{
	...
	public final void testSetupBasicLedgers() {
		try {
			 ...
			 * CashAccounts for the simple expedient that they are SingleLedger
			 * debit positive.
			 */
			...
			/*
			 * Treat first ledger as money account and second as if it were GST.
			 */
