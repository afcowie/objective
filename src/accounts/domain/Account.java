...
public class Account implements Normal
{
    ...
    public void addLedger(Ledger ledger) {
        ...
        if (!((ledger instanceof DebitPositiveLedger) || (ledger instanceof CreditPositiveLedger))) {
            throw new IllegalArgumentException(
                    "attempted to add a Ledger which is neither Debit nor Credit Postive!");
        }
        /*
         * setup
         */
    ...
    /**
     * Calculate the balance of the Account, a transient quantity. TODO This
     * may need to be made public to allow updates.
     * 
     */
     ...
     * Recalculates the internal balance. This may be unnecessary as the only
     * real usage of this is to replace an internal ledgers Set representation
     * with some other implementation of Set which would be based on the same
     * Ledger objects, but as ever don't trust the data...
     * 
     * @deprecated
     */
