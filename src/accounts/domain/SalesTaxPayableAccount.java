 ...
 * revolve through the same account. We use two (automatically created) ledgers
 * to record it. In the example of Australian GST, GST is added to and collected
 * from sales, whereas GST paid on purchases (expenses) is redeemable. When we
 * do a BAS Transaction, we can net these, and move the amount either to
 * Accounts Reivable if they owe us, or write a cheque and send off what we owe
 * them.
 * 
 * @author Andrew Cowie *
...
public class SalesTaxPayableAccount extends LiabilityAccount
{
	 ...
	 * 
	 * @param title
	 *            The name of the tax, to be used as the account title, ie "GST"
	 */
