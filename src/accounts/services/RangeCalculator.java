 ...
 * PayrollTransactions have start and end dates, but no particular need to store
 * the way they were composed. That may change, and if it does it this will have
 * to move to the domain layer. For the mean time, you can just use the getters
 * exposed for start and end date.
 * 
 * @author Andrew Cowie
 */
public class RangeCalculator
{
	...
	/**
	 * Work out the number of days represented by these dates. Note that this is
	 * <b>incluisve</b>.
	 * 
