 ...
 * what context you're ordering within. For Entries within a Ledger, we organize
 * by the characteristics of the parentTransactions. But for Entries within a
 * Transaction, we organize by the characteristics of the parentLedger and it's
 * parentAccount.
 * 
 * @author Andrew Cowie
...
public class EntryComparator implements Comparator
{
	...
	public int compare(Object o1, Object o2) {
		...
		if (orderingWithin instanceof Ledger) {
			 ...
			 * Transaction's Entries all have the same date, so So first sort by
			 * Account
			 */
			 ...
			 */
			throw new DebugException(orderingWithin.getClass().getName() + " is an invalid class to be ordering by");
		}
	}
}
