...
/**
 * Add a Worker (Employee, Subcontractor) to the database. This Command wires up
 * a Ledger for the Worker into the ReimbursableExpensesPayableAccount.
 * 
 * @author Andrew Cowie
 */
		...
		if (lS != null) {
			...
			while (lI.hasNext()) {
				...
				if (l.getName().equals(name)) {
					throw new IllegalStateException("There is already an Ledger with " + worker.getName()
